...
#   --force      overwrite completed-season files (nfl/cfbd/roster/advstats/schedule/gamelogs)
...
| Path | Purpose |
|---|---|
| `bin/update.mjs` | CLI dispatcher → nfl / cfbd / ktc / snapshots / roster / draft / playerids / advstats / schedule / gamelogs subcommands |
