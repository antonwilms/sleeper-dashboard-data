...
- **Direction:** app→data
- **Triggers:** any of the eleven listed `src/utils/` modules  ‖  `lib/projectionFactors.mjs`, `lib/panel.mjs`, `scripts/panel-run.mjs`, `test/panel-fit.test.mjs`
