...
// the app's rookie-calibration.md / rookie-availability.md) does NOT land
...
// meant to validate. That mirror lands in `reconstructShippedRookieProjection`
// (reserved name, no body yet) when CR-15's rookie mirror is discharged. See
// rookie-outcome-panels.md §1 Q4 for the full reasoning.
