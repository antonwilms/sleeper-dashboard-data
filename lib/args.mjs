...
/** The only subcommands that honour --all (scripts/update-{schedule,gamelogs,teamcontext,oline,snaps,depth}.mjs). */
export const ALL_SUBCOMMANDS = ['schedule', 'gamelogs', 'teamcontext', 'oline', 'snaps', 'depth'];
