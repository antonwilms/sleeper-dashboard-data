 ...
 *   birthdate, draftYear, draftRound, draftPick, draftOvr, undrafted } } — the
 *   two new fill-rate gates are pinned to this population (6,392 measured rows
 *   with a sleeper_id), not to `ids` (6,193, gsis-keyed only).
 */
